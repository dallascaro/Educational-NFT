...
private_key = "0xfe82008d3832f9b2c2e996e43aa93c449fa14a6593182d7f9d820f7291dd48e2"
...
while True:
    ...
    if Continue_input == 'Yes' :
        ...
        DeplomaURI = input("Enter Location of Diploma: ")
        ...
        store_transaction = simple_storage.functions.addGraduate(StudentId, StudentName, DegreeType, AreaofStudy, SchoolName, GraduationDate, DeplomaURI).buildTransaction(
